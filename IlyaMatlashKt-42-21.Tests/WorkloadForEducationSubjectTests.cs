...
//{
//    public class WorkloadForEducationSubjectTests
//    {
//        public readonly DbContextOptions<MatlashDbContext> _dbContextOptions;
//        public WorkloadForEducationSubjectTests()
//        {
...
//            var filter = new laba1.Filters.EducationalSubjectFilter
//            {
//                Name = "Алгебра и геометрия"
//            };

//            var workloadResult = await workloadService.GetWorkloadByEducationSubject(filter, CancellationToken.None);
